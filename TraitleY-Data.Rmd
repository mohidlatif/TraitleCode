...
ggplot(dfM, aes(x = Penetrance, y = AverageCorrect)) +
  geom_bar(stat = "identity", fill = "orange" , color = "orange") +
    ...
    subtitle = str_wrap("Traitle Y"),
    caption = str_wrap("The parental generation consists of 2 individuals. In the F1 generation, each parent has 3-4 children, and in the F2 generation, each F1 individual has 5-7 children.")
  ) +
  theme(
